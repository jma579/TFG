"""
Endpoints REST para el Módulo Catálogo.

Gestión de entidades académicas (Asignaturas, Programas, Menciones) y
procesamiento de fichas docentes (PDF).
"""
...
def procesar_ficha_endpoint(
    ...
    """Pipeline transaccional: valida, extrae, persiste y limpia."""
