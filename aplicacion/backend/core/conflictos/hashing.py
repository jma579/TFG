...
Genera identificadores únicos (hashes) para los conflictos detectados.
Evita duplicados cuando el mismo conflicto se detecta desde perspectivas diferentes.
"""
...
def _hash_unario(r: ResultadoDeteccion, recurso_id: int) -> str:
    """
    Genera hash para conflictos que involucran una sola entidad principal.
