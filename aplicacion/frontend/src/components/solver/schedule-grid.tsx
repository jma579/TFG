...
export function ScheduleGrid({
  ...
  return (
    <div className={cn('relative rounded-lg border bg-card shadow-sm overflow-auto max-h-[70vh]', className)}>
            ...
            {DAYS.map((_, dayIndex) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={cn(
                    'relative h-12 border-b border-r text-sm transition-colors',
