...
export function DropzoneFichas({ onFiles, accept = 'application/pdf' }: Props) {
  ...
  return (
    <div
      ...
      aria-label="Subir fichas (PDF) mediante arrastrar y soltar o pulsando"
    >
      <p className="text-sm">Arrastra aquí tus <b>fichas académicas (PDF)</b> o haz clic para seleccionarlas</p>
